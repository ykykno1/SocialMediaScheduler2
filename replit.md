...
- June 25, 2025. Fixed Facebook disconnect functionality:
  ...
  - Added automatic token refresh mechanism to handle expired tokens
  - Created /api/refresh-token endpoint for seamless token renewal
  ...
  - User confirmed functionality is working properly
