...
export const adminUserSchema = z.object({
  id: z.string(),
  username: z.string(),
  password: z.string().optional(), // For admin code login
...
export const subscriptionSchema = z.object({
  id: z.string(),
  userId: z.string(),
  plan: z.enum(['youtube_only', 'all_platforms']),
  status: z.enum(['active', 'cancelled', 'expired']),
  price: z.number(), // In ILS (14.90 or 24.90)
  stripeSubscriptionId: z.string().optional(),
  startDate: z.date(),
  endDate: z.date().optional(),
  autoRenew: z.boolean().default(true),
  paymentMethod: z.enum(['stripe', 'manual']),
  createdAt: z.date().default(() => new Date()),
  updatedAt: z.date().default(() => new Date())
});
...
// Connected account schema for social media platforms
