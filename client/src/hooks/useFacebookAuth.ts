...
export default function useFacebookAuth() {
  ...
  const login = useCallback(async () => {
    try {
      ...
      // Try direct navigation first - this should work better than popup
      console.log('Attempting direct navigation to Facebook...');
      
      // Store current URL for return
      const currentUrl = window.location.href;
      localStorage.setItem('facebook_return_url', currentUrl);
      
      // Navigate directly to Facebook
