...
const CITIES = [
  ...
  { name: 'ראשון לציון', chabadId: '467' },
  { name: 'חולון', chabadId: '228' },
  { name: 'בת ים', chabadId: '184' },
  { name: 'רמת גן', chabadId: '463' },
  { name: 'כפר סבא', chabadId: '291' },
  { name: 'הרצליה', chabadId: '242' },
  { name: 'רחובות', chabadId: '458' },
  { name: 'מודיעין', chabadId: '355' },
  { name: 'אשקלון', chabadId: '161' },
  { name: 'בית שמש', chabadId: '193' },
  { name: 'ניו יורק', chabadId: '402' },
  { name: 'לוס אנג\'לס', chabadId: '323' },
  { name: 'לונדון', chabadId: '320' },
  { name: 'פריז', chabadId: '417' },
