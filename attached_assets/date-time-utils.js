...
const DateTimeUtils = {
     ...
     */
    parseTime: function(timeStr, dateObj = null) {
     ...
     */
    getNextDayOfWeek: function(dayOfWeek, fromDate = new Date()) {
     ...
     */
    getNextShabbatEnter: function(enterTime, timeZone) {
     ...
     */
    getNextShabbatExit: function(exitTime, timeZone) {
     ...
     */
    isDuringShabbat: function(date, enterTime, exitTime) {
     ...
     */
    toISOStringWithTZ: function(date, timeZone = 'Asia/Jerusalem') {
...
// Expose the DateTimeUtils object globally
